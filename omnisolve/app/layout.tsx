...
export const metadata: Metadata = {
  title: 'ControlGrid Command Center',
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${inter.className} bg-background text-foreground h-screen overflow-hidden flex relative`}>
        ...
        <div className="absolute inset-0 z-[-1] opacity-40 bg-[radial-gradient(circle_at_20%_30%,rgba(59,130,246,0.15)_0%,transparent_50%),radial-gradient(circle_at_80%_80%,rgba(139,92,246,0.1)_0%,transparent_50%)] dark:opacity-40 opacity-10 pointer-events-none"></div>
