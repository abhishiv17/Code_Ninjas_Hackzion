...
function SignInView({
  ...
  const handleSubmit = async () => {
    ...
    console.log("Entered values:", { username: inputUsername, password: inputPassword });
    ...
    if (!user || user.username !== inputUsername) {
      ...
      // Intentionally not setting loading to false so button stays in loading state while redirecting
    }
  };
  ...
  return (
    <section className="left-panel">
      ...
      <div className="l-brand">
        ...
        <div>
          <span className="brand-name">ControlGrid</span>
          <span className="brand-tag">{t("drop_in_auth_kit")}</span>
        </div>
      </div>
      ...
      <div className="l-hero">
        <h1>
          {t("auth_hero_title1")}<br />
          <span className="gradient-text">{t("auth_hero_title2")}</span>
        </h1>
        <p>
          {t("auth_hero_desc")}
        </p>
      ...
      <div className="l-stats">
        <div className="stat">
          ...
          <span className="stat-label">{t("hack_window")}</span>
        </div>
        <div className="stat">
          <span className="stat-num">∞</span>
          <span className="stat-label">{t("possibilities")}</span>
        </div>
        <div className="stat">
          <span className="stat-num">01</span>
          <span className="stat-label">{t("great_idea")}</span>
        </div>
      </div>
    </section>
  );
...
export default function AuthPage() {
  ...
  return (
    <div className="auth-body w-full h-full"><main className="auth-shell">
      <LeftPanel />
