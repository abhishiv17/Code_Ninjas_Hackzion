    ...
    <div className="bg-card dark:bg-card/40 dark:backdrop-blur-md border border-gray-200 dark:border-white/5 rounded-xl flex flex-col h-full overflow-hidden shadow-sm dark:shadow-[inset_0_0_20px_rgba(0,0,0,0.2)]">
      <div className="px-6 py-4 border-b border-gray-100 dark:border-white/5 flex items-center justify-between bg-white dark:bg-black/20">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-gray-800 dark:text-gray-300 dark:drop-shadow-[0_0_5px_rgba(255,255,255,0.2)]">{t('live_telemetry_n124')}</h3>
        </div>
        <div className="flex items-center gap-3 text-xs">
          <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-red-400 shadow-[0_0_8px_rgba(248,113,113,0.8)] animate-pulse"></div> {t('temp')}</span>
          <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-blue-400 shadow-[0_0_8px_rgba(96,165,250,0.8)]"></div> {t('load')}</span>
        </div>
      </div>
