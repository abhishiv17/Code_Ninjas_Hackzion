  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="text-xs text-blue-400 mt-1 font-medium bg-blue-500/10 inline-block px-2 py-0.5 rounded border border-blue-500/20">{t('ai_assisted_efficiency')}</p>
      </div>
      ...
      <div className="mt-4 relative z-10">
        ...
        <div className="mt-3 flex items-center gap-3">
          <span className="text-sm text-gray-500 line-through decoration-red-500/50 hover:decoration-red-500 transition-colors">{t('previous_4_2_hours')}</span>
